...
public class AUCore{
	...
	public void forceDownload(String downloadLink, String pluginName){
		...
		try{
			...
			FileOutputStream fos = new java.io.FileOutputStream("plugins/iOno/" + pluginName + ".jar");
		...
		log.info("[AU]" + prefix + " Please copy iOno.jar from iOno folder to plugins folder.");
	}
